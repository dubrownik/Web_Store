...
{
    /// <inheritdoc />
    public partial class orsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductNameAtPurchase = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UnitPriceAtPurchase = table.Column<int>(type: "int", nullable: false),
